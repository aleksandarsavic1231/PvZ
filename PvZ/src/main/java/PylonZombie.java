...
public class PylonZombie extends Zombie {
	 ...
	 */
	public static final ImageIcon HEALTHY_PYLON = new ImageIcon("src/main/resources/healthyZombie.png");
	public static final ImageIcon DAMAGED_PYLON = new ImageIcon("src/main/resources/hurtZombie.png");
